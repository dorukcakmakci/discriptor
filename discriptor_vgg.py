...
with open("./data/dataset/train_dataset_vgg.pkl", "rb") as f:
    train_features = pickle.load(f)
    train_encoded_images = preprocess_dataset(train_features)
with open("./data/dataset/train_captions_vgg.pkl", "rb") as f:
...
with open("./data/dataset/validation_dataset_vgg.pkl", "rb") as f:
    validation_features = pickle.load(f)
    validation_encoded_images = preprocess_dataset(validation_features)
with open("./data/dataset/validation_captions_vgg.pkl", "rb") as f:
...
with open("./data/dataset/test_dataset_vgg.pkl", "rb") as f:
    test_features = pickle.load(f)
    test_encoded_images = preprocess_dataset(test_features)
with open("./data/dataset/test_captions_vgg.pkl", "rb") as f:
...
for i in range(1,epochs+1):
    ...
    model.save('./model_weights/model_vgg_epoch' + str(base+i) + '.h5')
